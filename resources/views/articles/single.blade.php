...
@isset($article)
    @section('title', 'Optimacros :: '.$article->title)
@endisset
            ...
            <div class="col-lg-12">
                <div class="banner-spot clearfix">
                    <div class="banner-img">
                        <img src="{{ asset('public/assets/front/upload/banner_01.jpg') }}" alt="" class="img-fluid">
                    </div><!-- end banner-img -->
                </div><!-- end banner -->
            </div><!-- end col -->
        </div><!-- end row -->
        ...
        <div class="custombox authorbox clearfix">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <img src="{{ asset('public/assets/front/upload/author.jpg') }}" alt="" class="img-fluid rounded-circle">
                </div><!-- end col -->
            ...
            <div class="row">
                    ...
                    <div class="blog-box">
                        <div class="post-media">
                            <a href="marketing-single.html" title="">
                                <img src="{{ asset('public/assets/front/upload/market_blog_02.jpg') }}" alt="" class="img-fluid">
                ...
                <div class="col-lg-6">
                    <div class="blog-box">
                        <div class="post-media">
                            <a href="marketing-single.html" title="">
                                <img src="{{ asset('public/assets/front/upload/market_blog_03.jpg') }}" alt="" class="img-fluid">
                                <div class="hovereffect">
                                    <span class=""></span>
                                </div><!-- end hover -->
                            </a>
                    ...
                    <div class="comments-list">
                        <div class="media">
                            <a class="media-left" href="#">
                                <img src="{{ asset('public/assets/front/upload/author.jpg') }}" alt="" class="rounded-circle">
                            </a>
                        ...
                        <div class="media">
                            <a class="media-left" href="#">
                                <img src="{{ asset('public/assets/front/upload/author_01.jpg') }}" alt="" class="rounded-circle">
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media last-child">
                            <a class="media-left" href="#">
                                <img src="{{ asset('public/assets/front/upload/author_02.jpg') }}" alt="" class="rounded-circle">
                            </a>
                            <div class="media-body">
