                            ...
                            <div class="list-group">
                                <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('public/assets/front/upload/small_04.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('public/assets/front/upload/small_05.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 last-item justify-content-between">
                                        <img src="{{ asset('public/assets/front/upload/small_06.jpg') }}" alt="" class="img-fluid float-left">
                    ...
                    <div class="widget">
                        ...
                        <div class="blog-list-widget">
                            <div class="list-group">
                                <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('public/assets/front/upload/small_01.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('public/assets/front/upload/small_02.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 last-item justify-content-between">
                                        <img src="{{ asset('public/assets/front/upload/small_03.jpg') }}" alt="" class="img-fluid float-left">
